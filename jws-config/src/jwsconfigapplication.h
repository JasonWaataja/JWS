...
#define JWS_TYPE_CONFIG_APPLICATION (jws_conifg_application_get_type ())
#define JWS_CONFIG_APPLICATION \
...
GType
jws_conifg_application_get_type (void);

JwsConfigApplication *
jws_conifg_application_new ();
